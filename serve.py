...
vllm_args = {
    ...
    "quantization": "fp8",  # online FP8 weight quantization — faster matmuls, lower memory
...
def main():
    ...
    try:
        ...
        # --- Log W&B summary ---
        summary = {"gsm8k_em": gsm8k_em, "format_valid_rate": format_rate}
        if lat:
            summary.update({
